...
import { Box, Button, ButtonGroup, Card, CardBody, CardFooter, Divider, Flex, Grid, Heading, Select, Stack,Image, Text } from '@chakra-ui/react'
    ...
    return (
      <>
        ...
        <Flex  w={'98%'} m={'auto'}>
            ...
            <Flex w={'25%'}>
            <Flex flexDir={'column'} w='100%' m='10px'   p={'29px'}  bg='white' borderRadius={'8px'} boxShadow='rgba(0, 0, 0, 0.35) 0px 5px 15px;' h='600px' overflow={'auto'} >
            ...
            <Box w='100%'   >
                ...
                <Heading fontSize={'xl'} display={'flex'} gap={'30px'} alignItems={'center'} > Women&sbquo;s Clothing:<Text fontSize={'small'} fontWeight={'normal'}>{data.length} products</Text> </Heading>
