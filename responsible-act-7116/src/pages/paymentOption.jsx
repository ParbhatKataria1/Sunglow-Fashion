          ...
          <Box w={"30%"}>
            <Box border={"1px solid lightgray"} borderRadius="5px" p={"15px"}>
              ...
              <Flex direction="column">
                ...
                <Divider mb={"15px"} />
                <Button onClick={handleSubmit} mb={"15px"}>
                  Continue To Payment
                </Button>
                {/* <Divider/> */}
  ...
  return (
    ...
    >
      ...
      <Image
        borderRadius={"9px"}
        w="200px"
        src="https://serving.photos.photobox.com/66232980d40147cdee77e3ba00340d4f6788f30bc5ce3b9f0f4d229ee96f6fef05e0f469.jpg"
      ></Image>
    </Flex>
  );
}
