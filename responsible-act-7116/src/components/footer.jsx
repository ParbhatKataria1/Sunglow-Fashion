...
export default function Footer() {
  ...
  return (
    ...
    >
      ...
      <Box bg={"#f7f6f2"} width={"90%"} margin={"auto"}>
        <Image
          height={204}
          width={3000}
          src={
            "https://images.ctfassets.net/5de70he6op10/2DRgCRXNIEkk0wIqUo2ywa/103ccf34ec8f615dab367fa63ac9c326/467884464-jan2023_sitefootbanners_update_downloadtheapp_ls.jpg"
          }
          alt="image"
        />
      </Box>
