...
export const LineOne=()=>{
    for(let i=0;i<26;i++){
      return <div><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/></div>
}
}
...
export default function LandingPageOne() {
  return (
    ...
    <Box width={"90%"} margin={"auto"} marginTop={"40px"} position={"relative"}>
        <Image src='https://images.ctfassets.net/5de70he6op10/3Ai7bUZtZi5xY42vRa7nCY/600452ed34e8abb5b1265b516e90ac88/474338746-aliving_hpg_ls_01_1_-2x.jpg?w=2640&q=80&fm=webp' alt='Dan Abramov'
    ...
    <Box width={"90%"} margin={"auto"} marginTop={"40px"} position={"relative"}>
        <Image src='https://images.ctfassets.net/5de70he6op10/3vtv3Gvfa44vTd7fQDHwr9/147c9e91271d486d330930659291ef57/474338798-aliving_hpg_ls_2.jpg?w=2640&q=80&fm=webp' alt='Dan Abramov'
        width={1357} height={1200} />
        <Button
            size='md'
            height='38px'
    ...
    <Box marginTop={"40px"} position={"relative"}>
        <Grid templateColumns='repeat(5, 1fr)' gap={7} width={"90%"} margin={"auto"}  zIndex={0}>
            <Box w='433px' h='10'>
            <Image src='https://images.ctfassets.net/5de70he6op10/4NItM5R5jBXtNWSmRXpU4b/0264ceff2a7530c15ead44cd820c2f08/468827138-aliving_hpg_ls_02-1.jpg?w=856&q=80&fm=webp' alt='Dan Abramov'
            ...
            <Box w='435px' h='10'>
            <Image src='https://images.ctfassets.net/5de70he6op10/4AhCDUEJiCf48c4pshO4p4/b49d20bb596b1028a199b29f157ada20/468827146-aliving_hpg_ls_02-2.jpg?w=856&q=80&fm=webp' alt='Dan Abramov'
            width={700} height={200} />
            <Button
                size='md'
                height='38px'
            ...
            <Box w='435px' h='10'>
            <Image src='https://images.ctfassets.net/5de70he6op10/2oz6iRPGHMnjxyOocDJk5l/2829025930a4750c85224a7dc4b04aea/468827151-aliving_hpg_ls_02-3.jpg?w=856&q=80&fm=webp' alt='Dan Abramov'
    ...
    <Box marginTop={"40px"} position={"relative"}>
        <Grid templateColumns='repeat(5, 1fr)' gap={7} width={"90%"} margin={"auto"}  zIndex={0}>
            <Box w='670px' h='10'>
            <Image src='https://images.ctfassets.net/5de70he6op10/5x2GqjhgdD7rieQ7czhkOH/12f26fa062afeac16feb7bf9fd0a370c/468827157-aliving_hpg_ls_03-1.jpg?w=1302&q=80&fm=webp' alt='Dan Abramov'
            width={700} height={200} />
            <Button
                size='md'
                height='38px'
            ...
            <Box w='663px' h='10'>
            <Image src='https://images.ctfassets.net/5de70he6op10/1JR8IBLWktjNMtiCNLf7zl/b167b8c2ceb077f0c0b39eee2b891ced/471757834-aliving_hpg_ls_03-2.jpg?w=1302&q=80&fm=webp' alt='Dan Abramov'
            width={700} height={200} />
            <Button
                size='md'
                height='38px'
    ...
    <Box marginTop={"40px"} position={"relative"}>
        <Grid templateColumns='repeat(5, 1fr)' gap={7} width={"90%"} margin={"auto"}  zIndex={0}>
            <Box w='433px' h='10'>
            <Image src='https://images.ctfassets.net/5de70he6op10/4UQ5sfQRkoGg4jCzacPEdA/5a1d1d73d71c9bf3f85225193db2a837/466660978-aliving_hpg_ls_04-3.jpg?w=856&q=80&fm=webp' alt='Dan Abramov'
            width={700} height={200} />
            <Button
                size='md'
                height='38px'
            ...
            >
            shop the Jerrelle Guy collection
            </Button>
            </Box>
            <Box w='435px' h='10'>
            <Image src='https://images.ctfassets.net/5de70he6op10/7BnHB4gSeEHeD4Y32rrXlf/b7763d3da4f594fdf1eac5694408099d/462036088-aliving_hpg_ls_04-1.jpg?w=856&q=80&fm=webp' alt='Dan Abramov'
            width={700} height={200} />
            <Button
                size='md'
                height='38px'
            ...
            >
            shop the Lauren Mclntosh collection
            </Button>
            </Box>
            <Box w='435px' h='10'>
            <Image src='https://images.ctfassets.net/5de70he6op10/ZlHzxEPMEzLvufhg8okez/0dbe4ef8729319310c2c6d9e8795db59/470539398-aliving_hpg_ls_04-3.jpg?w=856&q=80&fm=webp' alt='Dan Abramov'
            width={500} height={200} />
            <Button
                size='md'
                height='38px'
            ...
            >
            shop the Sarah Gordon collection
            </Button>
            </Box>
        </Grid>
    </Box>
 ...
 <Box width={"90%"} margin={"auto"}><hr/></Box>
  ...
  <SimpleGrid spacing={4} templateColumns='repeat(auto-fill, minmax(300px, 1fr))' width={"90%"} margin={"auto"} marginTop={"20px"}>
    <Box maxW='sm'>
            ...
            <Image src='https://images.ctfassets.net/5de70he6op10/2dD2tonI2K8G5x821oTXuC/ff4e76d1b0075315a7ca9ae3bac5a7c9/474338877-ls_customerfave_a.jpg?w=630&q=80&fm=webp' alt='Dan Abramov'
            width={357} height={200} />
            <Stack mt='6' spacing='3'>
            <Text pt='2' fontSize='sm' fontFamily={"times romer"}>
                CUSTOMER FAVORITE
            </Text>
            <Heading fontSize='22px' fontWeight={400} fontFamily={"times romer"}>The Voluspa Japonica Jar Candle</Heading>
            <Grid gridTemplateColumns={"repeat(5,13px)"} fontSize={"10px"}>
            <StarIcon/><StarIcon/><StarIcon/><StarIcon/><StarIcon/></Grid>
            <Text>
            My all-time favorite scented candle! Super fresh but not overpowering and such a beautiful jar.
            </Text>
            <Button 
                textDecoration={"underline"} 
                color={"blue.300"} 
    ...
    <Box maxW='sm'>
            ...
            <Image src='https://images.ctfassets.net/5de70he6op10/7L90B0XDPvzwjN32E1Tjt2/eb0ae96ed6d22f15236e22afee158919/474338881-ls_customerfave_c.jpg?w=630&q=80&fm=webp' alt='Dan Abramov'
            width={1357} height={1200} />
            <Stack mt='6' spacing='3'>
            <Text pt='2' fontSize='sm' fontFamily={"times romer"}>
                CUSTOMER FAVORITE
            </Text>
            <Heading fontSize='22px' fontWeight={400} fontFamily={"times romer"}>The Fern Storage Cabinet</Heading>
            <Grid gridTemplateColumns={"repeat(5,13px)"} fontSize={"10px"}>
            <StarIcon/><StarIcon/><StarIcon/><StarIcon/><StarIcon/></Grid>
            <Text>
            Top notch in both design & construction. A real quality piece...to cherish for many years.Top notch in both design.
            </Text>
            <Button 
                textDecoration={"underline"} 
                color={"blue.300"} 
    ...
    <Box maxW='sm'>
            ...
            <Image src='https://images.ctfassets.net/5de70he6op10/1BlW9pDXHDrsYjv0Plp6n2/b9c398ca0a0d16602bc7db3752394cf6/474338886-ls_customerfave_d.jpg?w=630&q=80&fm=webp' alt='Dan Abramov'
            width={1357} height={1200} />
            <Stack mt='6' spacing='3'>
            <Text pt='2' fontSize='sm' fontFamily={"times romer"}>
                CUSTOMER FAVORITE
            </Text>
            <Heading fontSize='22px' fontWeight={400} fontFamily={"times romer"}>The Lustered Velvet Alastair Quilt</Heading>
            <Grid gridTemplateColumns={"repeat(5,13px)"} fontSize={"10px"}>
            <StarIcon/><StarIcon/><StarIcon/><StarIcon/><StarIcon/></Grid>
            <Text>
            This quilt is even more beautiful in person! It washes well and keeps its velvety sheen. I could not be happier!!
            </Text>
            <Button 
                textDecoration={"underline"} 
                color={"blue.300"} 
    ...
    <Box marginTop={"40px"} position={"relative"}>
        <Grid templateColumns='repeat(5, 1fr)' gap={7} width={"90%"} margin={"auto"}  zIndex={0}>
            <Box w='670px' h='10'>
            <Image src='https://images.ctfassets.net/5de70he6op10/4UClPuvkeZHNAJXpvGMSVY/317ca755f0b8c690d03efa2051c51c5e/468827193-aliving_hpg_ls_05-1.jpg?w=1302&q=80&fm=webp' alt='Dan Abramov'
            width={700} height={200} />
            <Button
                size='md'
                height='38px'
            ...
            <Box w='663px' h='10'>
            <Image src='https://images.ctfassets.net/5de70he6op10/uQtmdv7h8BeqRin5L6oMd/eef2c2ec4478e045643c274231a38a6e/468827197-aliving_hpg_ls_05-2.jpg?w=1302&q=80&fm=webp' alt='Dan Abramov'
            width={700} height={200} />
            <Button
                size='md'
                height='38px'
    ...
    <Box width={"90%"} margin={"auto"} marginTop={"20px"}><Image src='https://images.ctfassets.net/5de70he6op10/tnwMf98WrLzJvHORas5fC/381eeaec38219b4659e03a30dd03bb9c/HomeL1_Gateway_LS_04-0.jpg?w=2640&q=80&fm=webp' alt='Dan Abramov' width={1500} height={200} /></Box>

    <Box marginTop={"40px"} position={"relative"}>
        <SimpleGrid templateColumns='repeat(5, 1fr)' gap={7} width={"90%"} margin={"auto"}  zIndex={0}>
            <Box w='433px' h='10'>
            <Image src='https://images.ctfassets.net/5de70he6op10/xQJV4jdAEo7CcNDdwL2Ky/7ee91c4f5e5d606b474cd6d4b945beee/471757866-aliving_hpg_ls_06-1.jpg?w=856&q=80&fm=webp' alt='Dan Abramov'
            width={700} height={200} />
            <Button
                size='md'
                height='38px'
            ...
            <Box w='435px' h='10'>
            <Image src='https://images.ctfassets.net/5de70he6op10/5PnoiCuSAxU4LEnyFpPfOC/47f08bb0f9d61ef752e8c39ff4c44ae8/474338942-aliving_hpg_ls_06-2.jpg?w=856&q=80&fm=webp' alt='Dan Abramov'
            width={700} height={200} />
            <Button
                size='md'
                height='38px'
            ...
            <Box w='435px' h='10'>
            <Image src='https://images.ctfassets.net/5de70he6op10/yAt8uAMOJupxn3bUufD33/31b879d425dcb256e6ead6c4410c35e5/471757873-aliving_hpg_ls_06-3.jpg?w=856&q=80&fm=webp' alt='Dan Abramov'
            width={500} height={200} />
            <Button
                size='md'
                height='38px'
